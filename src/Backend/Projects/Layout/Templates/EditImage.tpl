...
{form:editImage}
					...
					<td id="leftColumn">
						...
						<div class="box">
							...
							{option:item.filename}
								<p class="image"><img src="{$FRONTEND_FILES_URL}/projects/{$project.id}/128x128/{$item.filename}"/></p>
							{/option:item.filename}
	...
	<div class="fullwidthOptions">
		{option:showProjectsMedia}
		<a href="{$var|geturl:'media'}&project_id={$item.project_id}" class="button">
