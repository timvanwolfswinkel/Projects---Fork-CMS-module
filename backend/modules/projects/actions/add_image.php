 ...
 */
class BackendProjectsAddImage extends BackendBaseActionEdit
{
	/**
	 * The project record
	 *
	...
	private function validateForm()
	{
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				$this->redirect(BackendModel::createURLForAction('images') . '&project_id=' . $item['project_id'] . '&report=added&var=' . urlencode($item['title']) . '&highlight=row-' . $item['id']);
			}
		}
	}
}
